...
<head>
	...
	<script type="text/javascript">
		function deleteConfirm(id) {
			if (confirm("해당 프로젝트를 삭제합니다..!") == true) 
				location.href = "./deleteProject.jsp?id=" + id;
			else 
				return;
		}
	</script>
...
<body>
	...
	<div class="jb-box">
		...
		<div class="jc-text">
			<p class="vtext-big">Edit Project</p>
		</div>
	</div>
		...
		<div class="pj-box">
			...
			%>
				<div class="pj-box-inner">
					<!-- <img src="c:\upload\<%=rs.getString("p_fileName") %>" width="100%" alt=""> -->
					...
					<div class="normal-btn margin-h2">
						<button class="normal-btn-inner normal-sltext" onclick="deleteConfirm('<%=rs.getString("p_id") %>')" >삭제</button>
					</div>
				</div>
			<%
				}
